...
pub struct GetPriceResponse {
    #[prost(oneof = "get_price_response::Outcome", tags = "1, 2")]
    pub outcome: ::core::option::Option<get_price_response::Outcome>,
}
/// Nested message and enum types in `GetPriceResponse`.
pub mod get_price_response {
    #[derive(Clone, PartialEq, ::prost::Oneof)]
    pub enum Outcome {
        #[prost(message, tag = "1")]
        Ok(super::GetPriceSuccess),
        #[prost(message, tag = "2")]
        Error(super::PluginError),
    }
}
